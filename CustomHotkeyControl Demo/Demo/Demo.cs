    ...
    public partial class Demo : Form
    {
        ...
        public Demo()
        {
            ...
            if (File.Exists(Path.Combine(MainPath, "userconfig.ini")))
            {
                ...
                try
                {
                    ...
                    //Setting the Hotkey with the returned variables from UserHotKeyControl
                    ...
                    //locks the UserHotKeyControl against unintentional changes
        ...
        private void CustomHotkeyControl1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (CustomHotkeyControl.register)
            {
                ...
                //UserHotkeyControl.Display returns the hotkey as a string
                label2.Text = CustomHotkeyControl.Display;
                ...
                {
                    //UserHotkeyControl.SaveHotKey returns the hotkey as a string
        ...
        private void ResetButton_Click(object sender, EventArgs e)
        {
            ...
            //reset of the UserHotkeyControl 
        ...
        private void RightClickReset(object sender, MouseEventArgs e)
        {
            ...
            {
                //checks if the UserHotkeyControl is locked
                //otherwise right clicks on the UserHotkeyControl are ignored to block the contextmenu of windows
                if (customHotkeyControl1.locked == true)
                {
                    //Hotkey gets unregisterd
                    UnregisterHotKey(this.Handle, 0);

                    //resets the UserHotkeyControl
                    customHotkeyControl1.Reset();
                    label2.Text = customHotkeyControl1.Text;
