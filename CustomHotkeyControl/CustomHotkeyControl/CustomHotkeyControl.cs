...
namespace TzigoSoft
{
    public partial class CustomHotkeyControl : TextBox
    {
        ...
        public CustomHotkeyControl()
        {
            ...
            //verhindert das windows contextmenu
        ...
        void CustomHotkeyControl_KeyDown(object sender, KeyEventArgs e)
        {
            if (locked == false)
            {
                ...
                else
                {
                    ...
                    //prevents the error message when pressing the modifiers (eg when pressing Shift normally ShiftKey + Shift is displayed )
